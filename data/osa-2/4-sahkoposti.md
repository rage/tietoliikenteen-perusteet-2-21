...
Keskitytään hetkiseksi vain viestin lähettämiseen ja sähköpostipalvelimien toimintaan tässä yhteydessä. Otetaan vasta myöhemmin mukaan sähköpostipalvelimen ja asiakkaan välinen kommunikointi. Viestien lähettäminen asiakkaalta palvelimelle ei poikkea juurikaan viestin lähettämisestä palvelimelta toiselle. Viestien lukeminen puolestaan tapahtuu hyvin eri tavalla.
