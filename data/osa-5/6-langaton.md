...
<img alt="Ensimmmäisessä kuvassa on tukiasema ja kaksi sen kanssa kommunikoivaa laitetta A ja B. Kaikille laiteille on piirretty ympyränä niiden kuuluvuusalue. 
Toisessa kuvassa on kaksi tukiasemaa ja niiden välissä laitteet A ja B. A kommunikoi oman tukiasemansa kanssa ja B omansa. Tuiasemien kuuluvuus alueet eivät ole päällekkäin, mutta A ja B kuulevat oma tukiasemansa lisäksi myös toisensa. Piirtäjälle tiedoksi: Kätketyn aseman kohdaalla voi olla helpompi piirtää laitteet eri puolille tukiasemaa, kuin piirtää niiden väliin jokin este (esim talo tai vuori). Toki nämä ongelma saa yhdistää myös samaan kuvaan, jolloin tässä tekstissä ja kuvatekstissä täytyy viitata asemiin niiden kirjaimilla.">
KUVA. Kuvassa havainnollistettu sekä kätketyn aseman että näkyvän aseman ongelmaa.
